      ...
      <div className="flex flex-col lg:flex-row justify-between items-start gap-10">
        ...
        >
          <h3 className="text-3xl text-primary font-bold lg:w-1/2 mb-3">
            Tools that make your business grow
          </h3>
          <p className="text-base text-tartiary">
            Our solutions are tailored to enhance customer relationships, boost
            productivity, and increase your bottom line. Experience the future
            of business management with our cutting-edge CRM technology.
          </p>
        </motion.div>
        <motion.div
