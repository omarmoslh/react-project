  ...
  const packages = [
    {
      ...
      monthlyPrice: 19,
      yearlyPrice: 199,
      descraptin: "lorem sfdf hgghkg fjfjfjhghg fjj",
    ...
    <div className="md:px-14 p-4 max-w-s mx-auto py-10" id="pricing">
      <div className="text-center">
        <h2 className="md:text-5xl text-3xl font-extrabold text-primary mb-2">
          Tflorentina pricing and plans
        </h2>
        <p className="text-tartiary md:w-1/3 mx-auto px-4">
          Small business CRM solutions for medicaid providers
        </p>
        {/* toggle pricing */}
        <div className="mt-16">
          <label
      ...
      >
        {packages.map((pkg, index) => (
          ...
          >
            ...
            <p className="text-tartiary text-center my-5">{pkg.descraptin}</p>
